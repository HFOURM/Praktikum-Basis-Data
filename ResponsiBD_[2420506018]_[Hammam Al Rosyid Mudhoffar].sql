...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 22 Apr 2025 pada 13.53
...
('001A', 'Al Rosyid', 'Teknologi Informasi', '2024-05-06'),
('001B', 'Azrul', 'Teknologi Informasi', '2024-07-12'),
('002A', 'Fendi', 'Ekonomi Pembangunan', '2024-01-10');
...
('EPB1', 'Matematika Ekonomi', 'Gramedia', 2013, 'P1'),
('EPB2', 'Teori Ekonomi', 'Gramedia', 2015, 'P1'),
('TIFB1', 'Kalkulus Lanjut', 'Erlangga', 2011, 'P2'),
('TIFB2', 'Aljabar Linear', 'Erlangga', 2012, 'P2'),
('TIFB3', 'Paradigma Sistem', 'Gramedia', 2017, 'P1');
...
(1, '001A', 'TIFB1', '2024-09-12', '2025-01-17', 0),
(2, '001B', 'TIFB3', '2025-04-10', '2025-04-29', 0),
(3, '002A', 'EPB2', '2025-02-11', '2025-04-11', 0);
